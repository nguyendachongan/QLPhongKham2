...
(function (window, document, Chartist) {
  ...
  Chartist.getHighLow = function (data, options, dimension) {
    // TODO: Remove workaround for deprecated global high / low services. Axis high / low configuration is preferred
...
(function(window, document, Chartist) {
  ...
  function initialize() {
    ...
    // Initialize all relevant plugins with our chart object and the plugin options specified in the services
